...
const picks: Pick[] = [
  ...
  },
  {
    ...
    title: "Girl Gang Tee",
    image:
      "https://images.pexels.com/photos/12025472/pexels-photo-12025472.jpeg?auto=compress&cs=tinysrgb&w=800",
    blurb: '"Margarita\'s Girl Gang" across the front. Unisex fit, true to size.',
    kind: "merch",
    destinationUrl: "https://example.com/store/girl-gang-tee",
    network: "Fourthwall",
    sortOrder: 3,
    published: true,
    useRedirect: true,
    printOverlay: {
      text: "Margarita's Girl Gang",
      top: "42%",
      left: "50%",
      rotate: "-4deg",
      widthClass: "w-36 text-xl",
    },
  },
  {
    id: "4",
    slug: "girl-gang-panties",
    title: "Girl Gang Panties",
    image:
      "https://images.pexels.com/photos/7479438/pexels-photo-7479438.jpeg?auto=compress&cs=tinysrgb&w=800",
    blurb: '"Margarita\'s Girl Gang" printed waistband. Soft cotton, true to size.',
    kind: "merch",
    destinationUrl: "https://example.com/store/girl-gang-panties",
    network: "Fourthwall",
    sortOrder: 4,
    published: true,
    useRedirect: true,
  ...
  },
  {
    ...
    title: "GRL PWR! Socks",
    image:
      "https://images.pexels.com/photos/7692209/pexels-photo-7692209.jpeg?auto=compress&cs=tinysrgb&w=800",
    blurb: "Cozy crew socks, embroidered. One size fits most.",
    kind: "merch",
    destinationUrl: "https://example.com/store/grl-pwr-socks",
    network: "Fourthwall",
    sortOrder: 5,
    published: true,
    useRedirect: true,
  ...
  {
    id: "6",
    slug: "heart-charm-choker",
    title: "Heart Charm Choker",
    image:
      "https://images.pexels.com/photos/30722044/pexels-photo-30722044/free-photo-of-heart-pendant-necklace-on-butter-block.jpeg?auto=compress&cs=tinysrgb&w=800",
    blurb: "Dainty chain, little red heart. Adjustable length.",
    kind: "merch",
    destinationUrl: "https://example.com/store/heart-charm-choker",
    network: "Fourthwall",
    sortOrder: 6,
    published: true,
    useRedirect: true,
